...
function render(tab) {
  ...
  if(tab==='materials')html=head('課程教材','下載原始教材，或列印課文。')+`<div class="card download-list"><a href="materials/teachers-day-a2.docx" download>下載 Word 教材（原始檔）</a><a href="materials/lesson.md" download>下載課文、生詞與練習文字</a><a href="share.html">開啟課程 QR Code</a><a href="https://github.com/ij-teacher/Teachers-Day-A2-/tree/main/materials" target="_blank" rel="noopener">在 GitHub 查看教材</a></div>`;
